...
<style>
    ...
    /* Perbaikan warna teks global - memastikan teks tetap putih */
    body, p, span, label, div, h1, h2, h3, h4, h5, h6, li, a, .stMarkdown, .stText {
        color: white !important;
    }
    
    /* Override untuk teks dalam sidebar */
    ...
    /* Force text color on specific containers to ensure visibility */
    .content-container, .header-container {
        color: white !important;
    }
    
    /* Override untuk input teks di sidebar */
    .stTextInput input, .stNumberInput input {
        color: black !important;
    }
    
    /* Pastikan warna teks kontainer konten tetap putih */
    .content-container p, 
    ...
    /* Perbaikan warna teks untuk options di selectbox */
    .stSelectbox div[role="listbox"] div[role="option"] {
        color: black !important;
    }

    /* Perbaikan untuk warna teks di multiselect */
    ...
    /* Memastikan teks dalam tabel tetap terlihat */
    ...
    /* Perbaikan untuk warna teks dalam tab yang dipilih */
    ...
    @media (max-width: 768px) {
        ...
        /* Memastikan teks tetap terlihat pada layar mobile */
        body, p, span, label, div, li, a {
            color: white !important;
        }
        
        /* Memastikan kontras yang cukup untuk teks di mobile */
        .content-container, .header-container {
            background-color: rgba(52, 73, 94, 0.95);
        }
        
        /* Perbaikan untuk tabel pada mobile */
        .dataframe {
            font-size: 12px !important;
        }
    }

    /* Custom styles untuk link dalam tabel HTML */
    table.dataframe a {
...
function checkMobile() {
    ...
    localStorage.setItem('is_mobile', isMobile ? 'true' : 'false');
    
    // Tambahkan kelas khusus untuk mobile jika perlu
    if (isMobile) {
...
// Juga panggil fungsi saat ukuran window berubah
